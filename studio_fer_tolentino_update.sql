...
CREATE TABLE `caixa` (
  ...
  `caixa_descricao` text DEFAULT NULL,
  `caixa_servico_produto` int(1) DEFAULT NULL, -- Novo --
  `servicos_servico_id` int(11) DEFAULT NULL,
  `produtos_produto_id` int(11) DEFAULT NULL,
  `clientes_cliente_id` int(11) DEFAULT NULL,
  `agenda_agenda_id` int(11) DEFAULT NULL -- Novo --
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `caixa`
  ...
  ADD UNIQUE KEY `fk_caixa_agenda_idx` (`agenda_agenda_id`) USING BTREE, -- Novo --
